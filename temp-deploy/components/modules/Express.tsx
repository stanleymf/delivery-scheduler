...
import { Zap, Plus, Edit, Trash2, AlertCircle, DollarSign } from "lucide-react";
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Manage express delivery time slots with premium fees</p>
          </div>
        </div>
        <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
          ...
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              ...
              <DialogDescription>
                Configure a premium express delivery slot with custom fees within an existing delivery timeframe.
              </DialogDescription>
            </DialogHeader>
      ...
      <Card className="border-amber-200 bg-amber-50/50">
        <CardHeader>
          ...
          <CardDescription>
            Express slots are premium delivery windows with additional fees. They offer faster, more precise delivery times with limited capacity.
          </CardDescription>
        </CardHeader>
      </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Premium delivery slots with fees and limited capacity
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
              ...
              <div key={slot.id} className="flex items-center justify-between p-4 border rounded-lg bg-amber-50/30">
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    {slot.fee && slot.fee > 0 && (
                      <span className="text-amber-600 font-medium"> • +${slot.fee.toFixed(2)} express fee</span>
                    )}
                  </p>
                  <p className="text-sm text-muted-foreground">
